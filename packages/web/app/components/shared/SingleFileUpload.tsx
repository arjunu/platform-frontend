...
export const SingleFileUploadSpinner: React.FunctionComponent<{ message?: TTranslatedString }> = ({
  message,
}) => (
...
export const SingleFileUploadActionButtons: React.FunctionComponent<IActionButtons> = ({
  className,
  downloadAction,
  busy,
  linkDisabled,
